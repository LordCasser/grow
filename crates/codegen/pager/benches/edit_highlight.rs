...
//!
//! ```text
//! cargo bench -p pager --bench edit_highlight
//! cargo bench -p pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use pager::diff::{DiffHunk, DiffLine};
use pager::scrollback::blocks::tool::{
...
use pager::syntax::{Syntect, get_syntect};
