//! Criterion benchmarks for the pager rendering pipeline.
//!
...
use pager::scrollback::render::render_scrolled_entries_with_scratch;
use pager::scrollback::wrappers::EntryRenderer;
use pager::scrollback::{EntryId, EntryLayoutInfo, HorizontalLayout, RenderBlock, ScrollbackState};
