...
use pager_pty_harness::PtyHarness;
pub(crate) use pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `pager-pty-harness/src/scroll_matrix/session.rs` is a port of
