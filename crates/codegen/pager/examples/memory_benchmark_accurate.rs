...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "grow-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "grow-3", "researcher");
    ...
    let shared_models = ["grow-3", "grow-3-mini"];
