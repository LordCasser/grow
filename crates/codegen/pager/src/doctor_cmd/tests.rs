...
fn mixed_report() -> DiagnosticReport {
    ...
    report.facts.color = ColorFacts {
        ...
        available_themes: vec![ThemeKind::GrowNight, ThemeKind::GrowDay],
        total_themes: ThemeKind::ALL.len(),
    };
    ...
    report.findings = vec![
        ...
        DiagnosticFinding {
            ...
            message: "Use local SSH wrapping".to_owned(),
            remediation: Some(ManualRemediation {
                fix: "grow wrap ssh <host>".to_owned(),
                config_path: None,
            }),
            automatic_remediation: Some(crate::diagnostics::ssh_wrap_automatic_remediation()),
            note: None,
...
fn human_mixed_fixture_is_exact() {
    assert_eq!(
        ...
        concat!(
            ...
            "    → Automatic setup: `grow doctor fix ssh-wrap`\n",
            "    → One-off: `grow wrap ssh <host>`\n",
            "\n",
            ...
            "  Some checks only run in Grow. Start Grow and run /doctor.\n",
            "\n",
...
fn fix_preview_contains_exact_change_and_caveats() {
    ...
    assert!(preview.contains("To use once without changing config: `grow wrap ssh <host>`"));
...
fn json_contract_is_structural_stable_ordered_and_ansi_free() {
        ...
        serde_json::json!({
            ...
            "facts": {
                ...
                "color": {
                    ...
                    "availableThemes": ["grownight", "growday"],
                    "totalThemes": 5
                },
            ...
            "findings": [
                ...
                },
                {
                    ...
                    "remediation": {"fix": "grow wrap ssh <host>", "configPath": null},
                    "automaticRemediation": {
                        "fixId": "terminal.ssh-wrap",
                        "command": "grow doctor fix terminal.ssh-wrap"
                    },
                    "note": null
                }
            ],
    ...
    assert!(!text.contains("Grow Doctor"));
}
...
fn new_named_findings_extend_json_without_schema_changes() {
    ...
    report.facts.clipboard.fix = Some("grow wrap <ssh command> or /minimal".to_owned());
    report.findings.push(DiagnosticFinding {
    ...
    assert_eq!(
        ...
        "grow wrap <ssh command> or /minimal"
    );
