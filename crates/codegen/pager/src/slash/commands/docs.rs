...
//! `/docs web` opens the Grow repository documentation in the browser.
...
pub const BUILD_DOCS_URL: &str = "https://github.com/LordCasser/grow#readme";
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open Grow documentation in the browser".into(),
            },
        ];
