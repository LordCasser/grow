...
//! the generic [`CodeBlockSpan`](markdown::CodeBlockSpan) API) and
...
pub struct MermaidBlock {
    ...
    /// from [`CodeBlockSpan::body`](markdown::CodeBlockSpan::body). For
    ...
    /// [`CodeBlockSpan::output_line_range`](markdown::CodeBlockSpan::output_line_range).
...
/// dark. The render worker maps this to `mermaid::MermaidTheme`; it
