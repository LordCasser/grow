...
pub enum Action {
    ...
    ExecuteHooksAction(extension_types::HooksAction),
    /// Execute a plugins management action from the modal.
    ExecutePluginsAction(extension_types::PluginsAction),
    /// Execute a marketplace management action from the modal.
    ExecuteMarketplaceAction(extension_types::MarketplaceAction),
...
pub enum Effect {
    ...
    MarketplaceAction {
        agent_id: AgentId,
        session_id: acp::SessionId,
        action: extension_types::MarketplaceAction,
    },
...
pub enum TaskResult {
    ...
    HooksActionResult {
        agent_id: AgentId,
        result: Result<extension_types::ActionOutcome, String>,
    },
