...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        ...
        shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        shell::session::PromptOrigin::from_prompt_id(prompt_id),
        shell::session::PromptOrigin::TaskCompleted { .. }
            | shell::session::PromptOrigin::SubagentCompleted { .. }
            | shell::session::PromptOrigin::WorkflowCompleted { .. }
            | shell::session::PromptOrigin::NotificationDrain
    )
}
