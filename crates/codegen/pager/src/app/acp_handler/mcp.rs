...
/// `shell/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// on config reload (`crates/codegen/shell/src/agent/mvp_agent.rs`
