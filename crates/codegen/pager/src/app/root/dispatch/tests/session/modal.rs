...
fn open_extensions_modal_no_session_sets_flag_no_fetches() {
    ...
    let effects = dispatch(
        Action::OpenExtensionsModal {
            ...
            trigger: diagnostics::events::ExtensionsModalTrigger::SlashCommand,
        },
        &mut app,
    );
...
fn success_outcome() -> extension_types::ActionOutcome {
...
fn empty_marketplace_response() -> extension_types::MarketplaceListResponse {
    extension_types::MarketplaceListResponse { sources: vec![] }
}
