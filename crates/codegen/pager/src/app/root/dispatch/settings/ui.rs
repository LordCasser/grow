...
use crate::app::root::dispatch::ctx::with_active_agent;
use crate::app::root::dispatch::router::dispatch;
use crate::app::root::dispatch::turn::apply_cancel_subagents_preference_global;
use crate::app::root::{ActiveView, AppView};
use crate::scrollback::block::RenderBlock;

/// Format a "✓ Label: value" success toast.
pub(in crate::app::root::dispatch) fn save_success_toast(label: &str, on: bool) -> String {
...
pub(in crate::app::root::dispatch) fn dispatch_open_command_palette(
    app: &mut AppView,
) -> Vec<Effect> {
    use crate::views::modal::ActiveModal;
...
pub(in crate::app::root::dispatch) fn dispatch_open_howto_guides(app: &mut AppView) -> Vec<Effect> {
    use crate::views::modal::ActiveModal;
    let ActiveView::Agent(id) = app.active_view else {
        return vec![];
    };
    ...
    let id = match app.active_view {
        ...
        _ => {
            if let Some(existing) = app.agents.keys().next().copied() {
                crate::app::root::dispatch::ctx::switch_to_agent(
                    app,
                    existing,
                    crate::app::root::dispatch::ctx::SwitchCause::Picker,
                );
                existing
            } else {
...
pub(in crate::app::root::dispatch) fn dispatch_open_reset_confirm(
    app: &mut AppView,
...
pub(in crate::app::root::dispatch) fn dispatch_confirm_reset_setting(
    app: &mut AppView,
...
pub(in crate::app::root::dispatch) fn dispatch_toggle_multiline(app: &mut AppView) -> Vec<Effect> {
    let ActiveView::Agent(id) = app.active_view else {
        return vec![];
    };
...
pub(in crate::app::root::dispatch) fn dispatch_toggle_compact_mode(
    app: &mut AppView,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn dispatch_toggle_vim_mode(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn dispatch_toggle_timestamps(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn dispatch_toggle_mouse_capture(app: &mut AppView) {
...
pub(in crate::app::root::dispatch) fn action_for_reset(
    key: crate::settings::SettingKey,
...
pub(in crate::app::root::dispatch) fn apply_setting_rollback(
    app: &mut AppView,
    key: crate::settings::SettingKey,
