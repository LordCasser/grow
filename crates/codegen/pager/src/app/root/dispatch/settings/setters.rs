...
pub(in crate::app::root::dispatch) fn set_multiline_mode(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_render_mermaid(
    app: &mut AppView,
...
pub(in crate::app::root::dispatch) fn set_screen_mode(
    app: &mut AppView,
    value: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_hunk_tracker_mode(
    app: &mut AppView,
    value: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_vim_mode(app: &mut AppView, new: bool) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_remember_tool_approvals(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
/// `Effect::PersistSetting`. Applies to new sessions (restart-required).
pub(in crate::app::root::dispatch) fn set_ask_user_question_timeout_enabled(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_show_thinking_blocks(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_group_tool_verbs(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
/// `GROW_PROMPT_SUGGESTIONS` env var overrides the effective value.
pub(in crate::app::root::dispatch) fn set_prompt_suggestions(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_keep_text_selection(
    app: &mut AppView,
...
pub(in crate::app::root::dispatch) fn set_scroll_speed(app: &mut AppView, raw: i64) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_scroll_mode(
    app: &mut AppView,
...
pub(in crate::app::root::dispatch) fn set_invert_scroll(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
/// bounds.
pub(in crate::app::root::dispatch) fn set_scroll_lines(app: &mut AppView, raw: i64) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_respect_manual_folds(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_default_selected_permission(
    app: &mut AppView,
    new: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_compact_mode(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_timestamps(app: &mut AppView, new: bool) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_timeline(app: &mut AppView, new: bool) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_page_flip_on_send(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_combine_queued_prompts(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_simple_mode(app: &mut AppView, new: bool) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_undo(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_plan_mode(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_image_input(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_send_now(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_small_screen(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_word_select(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_contextual_hint_ssh_wrap(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_theme(app: &mut AppView, new: String) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn preview_theme(
    _app: &mut AppView,
    new: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_auto_dark_theme(
    app: &mut AppView,
    new: String,
) -> Vec<Effect> {
    let prev_canonical: &'static str = app
        ...
        .and_then(crate::theme::canonical_name)
        .filter(|s| *s != "auto")
        // No prior config: fall back to GrowNight (the default).
        .unwrap_or_else(|| crate::theme::ThemeKind::GrowNight.display_name());
    let new_canonical = match crate::theme::canonical_name(&new) {
...
pub(in crate::app::root::dispatch) fn preview_auto_dark_theme(
    _app: &mut AppView,
    new: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_auto_light_theme(
    app: &mut AppView,
    new: String,
) -> Vec<Effect> {
    let prev_canonical: &'static str = app
        ...
        .and_then(crate::theme::canonical_name)
        .filter(|s| *s != "auto")
        .unwrap_or_else(|| crate::theme::ThemeKind::GrowDay.display_name());
    let new_canonical = match crate::theme::canonical_name(&new) {
        Some(c) if c != crate::theme::ThemeKind::Auto.display_name() => c,
        _ => {
            tracing::error!(
...
pub(in crate::app::root::dispatch) fn preview_auto_light_theme(
    _app: &mut AppView,
    new: String,
) -> Vec<Effect> {
    match crate::theme::canonical_name(&new) {
...
pub(in crate::app::root::dispatch) fn clear_default_model(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn clear_fork_secondary_model(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_max_thoughts_width(
    app: &mut AppView,
    new: i64,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_show_tips(app: &mut AppView, new: bool) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_auto_update(app: &mut AppView, new: bool) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn set_display_refresh_auto_cadence(
    app: &mut AppView,
    new: bool,
) -> Vec<Effect> {
