...
pub(in crate::app::root::dispatch) fn dispatch_new_session(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn open_new_session_question(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn dispatch_exit_session(app: &mut AppView) -> Vec<Effect> {
    let effects =
        unregister_session_effect(get_active_agent(app).and_then(|a| a.session.session_id.clone()));
    show_welcome(app);
...
pub(in crate::app::root::dispatch) fn open_delete_current_session_question(
    app: &mut AppView,
) -> Vec<Effect> {
    use crate::views::question_view::{LocalQuestionKind, QuestionViewState};
    use tools::implementations::grow_build::ask_user_question::{Question, QuestionOption};
...
pub(in crate::app::root::dispatch) fn dispatch_delete_current_session_answered(
    app: &mut AppView,
    confirmed: bool,
) -> Vec<Effect> {
    if !confirmed {
...
pub(in crate::app::root::dispatch) fn finish_trust(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn drain_startup_actions(app: &mut AppView) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn dispatch_new_worktree_session(
    app: &mut AppView,
...
pub(in crate::app::root::dispatch) fn dispatch_new_session_with_id(
    app: &mut AppView,
    session_id: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn skip_picker_and_create_session(
    app: &mut AppView,
    agent_id: AgentId,
) -> Vec<Effect> {
    let pending = app
...
pub(in crate::app::root::dispatch) fn handle_session_created(
    app: &mut AppView,
    agent_id: AgentId,
...
pub(in crate::app::root::dispatch) fn handle_worktree_session_created(
    app: &mut AppView,
    agent_id: AgentId,
    session_id: acp::SessionId,
...
pub(in crate::app::root::dispatch) fn handle_session_failed(
    app: &mut AppView,
    agent_id: AgentId,
    error: String,
) -> Vec<Effect> {
...
pub(in crate::app::root::dispatch) fn handle_worktree_session_failed(
    app: &mut AppView,
    agent_id: AgentId,
    error: String,
) -> Vec<Effect> {
