...
impl AgentView {
    ...
    pub(in crate::app) fn enter_inline_edit(&mut self, entry_idx: usize) -> bool {
        ...
        let Some(prompt_index) =
            crate::app::root::dispatch::shell_prompt_index_at(&self.scrollback, entry_idx)
        else {
            return false;
        };
    ...
    pub(in crate::app) fn exit_inline_edit(&mut self) {
