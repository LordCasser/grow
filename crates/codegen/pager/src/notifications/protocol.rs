...
pub enum NotificationProtocol {
    ...
    Osc9,
    /// Kitty: `\x1b]99;i=grow;{message}\x1b\\`
    Osc99,
...
pub fn emit_notification(
    ...
    let sequence: Cow<'_, str> = match protocol {
        ...
        NotificationProtocol::Osc99 => format!("\x1b]99;i=grow;{body} \u{b7} {title}\x1b\\").into(),
        NotificationProtocol::Osc777 => format!("\x1b]777;notify;Grow;{body}\x1b\\").into(),
