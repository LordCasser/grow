...
impl SettingsModalState {
    ...
    /// Rebuild rows from current process gates.
...
/// Row visibility for settings unavailable in minimal mode.
...
/// Maximum number of enum choices rendered without allocation.
