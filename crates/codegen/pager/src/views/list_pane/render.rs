...
mod tests {
    ...
    fn highlight_match_wrap_mode_real_tracing_line() {
        ...
        let styled = Line::from(vec![
            ...
            Span::styled(":", Style::default().fg(Color::DarkGray)),
            Span::raw(" "),
            Span::styled("grow_session:", Style::default().fg(Color::DarkGray)),
            Span::raw(
