...
fn is_critical(a: &announcements::Announcement) -> bool {
    a.severity.as_deref() == Some("critical")
}

fn is_promo(a: &announcements::Announcement) -> bool {
...
fn is_live_critical(a: &announcements::Announcement, now: chrono::DateTime<chrono::Utc>) -> bool {
...
fn is_live_promo(a: &announcements::Announcement, now: chrono::DateTime<chrono::Utc>) -> bool {
...
pub fn is_dismissible(a: &announcements::Announcement) -> bool {
...
fn is_hidden(a: &announcements::Announcement, hidden_ids: &BTreeSet<String>) -> bool {
...
fn usable_cta(a: &announcements::Announcement) -> Option<(&str, &str)> {
...
pub(crate) fn usable_cta_caption(a: &announcements::Announcement) -> Option<&str> {
...
fn first_critical_session_announcement<'a>(
    announcements: &'a [announcements::Announcement],
    hidden_ids: &BTreeSet<String>,
) -> Option<&'a announcements::Announcement> {
...
pub(crate) fn promo_cta<'a>(
    announcements: &'a [announcements::Announcement],
    hidden_ids: &BTreeSet<String>,
) -> Option<(&'a announcements::Announcement, &'a str, &'a str)> {
...
pub fn promo_cta_target<'a>(
    announcements: &'a [announcements::Announcement],
    hidden_ids: &BTreeSet<String>,
) -> Option<(&'a announcements::Announcement, &'a str)> {
...
pub fn has_session_announcements(announcements: &[announcements::Announcement]) -> bool {
...
mod tests {
    ...
    fn promo_cta_target_yields_to_critical_slot_owner() {
        ...
        assert_eq!(
            ...
            Some((Some("p"), "https://example.com/promo"))
        );
    ...
    fn usable_cta_rejects_unsafe_schemes() {
        ...
        for good in ["https://example.com/promo", "https://example.com/promo"] {
