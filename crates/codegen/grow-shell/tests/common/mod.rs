//! Shared helpers for grow-shell integration tests.

use grow_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use grow_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `grow_sampler::SamplingClient`, which takes a
