//! `AcpTerminalAdapter`: implements `grow-tools::TerminalBackend` over ACP
...
/// Wraps grow-shell's ACP gateway to satisfy grow-tools' TerminalBackend.
