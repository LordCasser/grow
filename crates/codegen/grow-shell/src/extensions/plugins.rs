//! `grow/plugins/*` extension handlers.
//!
...
pub fn loaded_plugin_to_info(plugin: &grow_agent::plugins::LoadedPlugin) -> PluginInfo {
    use grow_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &grow_agent::plugins::PluginOrigin) -> PluginOrigin {
    use grow_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
...
mod tests {
    use super::*;
    use grow_agent::plugins::PluginOrigin as AgentOrigin;
    use grow_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> grow_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        grow_agent::plugins::LoadedPlugin {
