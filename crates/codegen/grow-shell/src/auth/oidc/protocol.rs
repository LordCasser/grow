...
use super::super::config::{
    ForceLoginTeam, OAuth2ProviderConfig, OidcAuthConfig, ServiceAuthConfig,
};
use super::super::{AuthMode, ProviderAuth};
use base64::Engine;
...
pub fn is_configured(config: &ServiceAuthConfig) -> bool {
    config.oidc.is_some()
}
...
pub(crate) fn login_principal_policy(cfg: &ServiceAuthConfig) -> Option<ForceLoginTeam> {
...
mod tests {
    ...
    fn peek_access_token_principal_matrix() {
        ...
        let team_jwt = make_jwt(serde_json::json!({
            ...
            "exp": 9999999999u64,
            "iat": 1000000000u64,
            "scope": "offline_access grow-cli:access api:access",
            "principal_type": "Team",
