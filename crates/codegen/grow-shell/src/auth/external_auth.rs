...
/// Parse stdout into a session-credential `ProviderAuth`.
pub(crate) fn parse_output(output: &std::process::Output) -> anyhow::Result<ProviderAuth> {
...
pub(crate) async fn run_external_refresh(command: &str) -> Option<ProviderAuth> {
