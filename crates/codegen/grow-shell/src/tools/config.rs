use crate::models;
use grow_sampler::SamplerConfig;
...
impl WebFetchToolConfig {
    ...
    pub fn resolve_params(
    ...
    ) -> grow_tools::implementations::grow_build::web_fetch::WebFetchParams {
        ...
        let allow_local = self
            .allow_local
            .or_else(|| grow_config::env_bool("GROW_WEB_FETCH_ALLOW_LOCAL"));
...
/// from `grow_tools::registry::types::ToolsetConfig` which holds
