...
//
// State is persisted to `~/.grow/claude_import_state.json`.
...
use grow_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.grow/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::grow_home::grow_home().join("claude_import_state.json")
}
