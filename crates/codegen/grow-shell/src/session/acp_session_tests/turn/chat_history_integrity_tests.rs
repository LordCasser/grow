...
use grow_test_support::{MockInferenceServer, ScriptedResponse};
...
fn mid_turn_user_injection_must_not_duplicate_tool_results_for_one_tool_use_id() {
    std::thread::Builder::new()
        .name("mid_turn_user_injection_must_not_duplicate_tool_results_for_one_tool_use_id".into())
        ...
        .spawn(|| {
            ...
            local
                .run_until(async {
                    ...
                    let sampling_cfg = grow_sampler::SamplerConfig {
