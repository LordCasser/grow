...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use grow_tools::implementations::grow_build::task::types::SubagentOutstandingReply;
...
fn scripted_outstanding_responder(
    replies: Vec<grow_tools::implementations::grow_build::task::types::SubagentOutstandingReply>,
