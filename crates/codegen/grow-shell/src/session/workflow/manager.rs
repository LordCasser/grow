...
impl WorkflowManager {
    ...
    fn cancel_children_for_run(&self, run_id: &str) -> bool {
        ...
        self.subagent_event_tx
            .send(
                grow_tools::implementations::grow_build::task::types::SubagentEvent::Cancel(
                    grow_tools::implementations::grow_build::task::types::SubagentCancelRequest {
                        parent_session_id: Some(self.session_id.clone()),
                        target: grow_tools::implementations::grow_build::task::types::SubagentCancelTarget::WorkflowRunId(
                            run_id.to_owned(),
                        ),
                        respond_to,
                    },
...
mod tests {
    ...
    type CancelLog = Arc<
        parking_lot::Mutex<
            Vec<grow_tools::implementations::grow_build::task::types::SubagentCancelTarget>,
        >,
    >;
    ...
    async fn pause_marks_user_paused_and_resume_replays() {
        ...
        use grow_tools::implementations::grow_build::task::types::SubagentEvent;
        ...
        use grow_tools::implementations::grow_build::task::types::SubagentResult;
    ...
    async fn workflow_spawns_await_to_completion() {
        ...
        assert_eq!(
            ...
            grow_tools::implementations::grow_build::task::types::ModelOverrideProvenance::Tool,
