...
//! window containing a [`grow_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`grow_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`grow_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`grow_mcp::servers::ClientStateKind::Empty`]
...
use grow_mcp::servers::{McpClientEventKind, McpServerName};
...
/// ACP `grow/mcp/server_status` notification. Failures are logged and
