use grow_telemetry::events::SessionHarness;
...
pub(crate) struct SessionHarnessMetrics {
    ...
    pub permission_mode: grow_telemetry::enums::PermissionMode,
...
impl SessionHarnessMetrics {
    pub async fn into_event(self, hooks: Vec<HookRegInfo>) -> SessionHarness {
        ...
        SessionHarness {
            ...
            is_git_repo: grow_telemetry::context::collect_git_context(&self.cwd).is_git_repo,
