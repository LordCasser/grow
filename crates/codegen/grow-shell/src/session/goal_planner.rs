...
///
/// [`SubagentRuntimeOverrides::harness_agent_type`]: grow_tools::implementations::grow_build::task::types::SubagentRuntimeOverrides::harness_agent_type
...
mod tests {
    ...
    fn planner_template_default_render_preserves_wording_and_has_no_placeholders() {
        ...
        // (grow-build) tool names; guards against accidental wording drift.
