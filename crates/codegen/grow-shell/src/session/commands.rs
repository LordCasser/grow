...
pub enum SideQuestionError {
    ...
    Sampling(#[from] grow_sampling_types::SamplingError),
...
pub enum SessionCommand {
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<grow_agent::plugins::PluginRegistry>>,
    },
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<grow_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<grow_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<grow_tools::types::TaskSnapshot>>>,
    },
    ...
    PluginsList {
        respond_to: oneshot::Sender<Option<std::sync::Arc<grow_agent::plugins::PluginRegistry>>>,
    },
