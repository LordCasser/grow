...
/// `grow-workspace`.
use grow_workspace::permission::resolution::yolo_disabled_by_policy;
...
mod tests {
    ...
    // definition in `grow_workspace::permission::claude_compat`.

    #[test]
    fn resolve_launch_yolo_policy_pin_neutralizes_requested_bypass() {
        let warning = grow_workspace::permission::resolution::YOLO_PIN_REASON_REQUIREMENTS;
