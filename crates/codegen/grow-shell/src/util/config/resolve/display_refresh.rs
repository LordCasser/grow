...
use grow_config_types::DisplayRefreshSettings;
use serde::Deserialize;
use toml::Value as TomlValue;

pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "GROW_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "GROW_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`GROW_MIN_DRAW_MS` / `GROW_SCROLL_CADENCE_MS`).
