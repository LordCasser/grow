...
mod tests {
    ...
    #[test]
    fn success_response_projects_grow_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["grow/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["grow/partial"]["reason"], "no_oauth");
    }
}
