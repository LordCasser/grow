...
/// Returns whether a session-less startup is about to mint a service.example.com session
pub(crate) fn is_session_pending(has_session: bool, auth: &crate::auth::ServiceAuthConfig) -> bool {
    !has_session
