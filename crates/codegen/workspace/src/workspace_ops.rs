...
fn hook_registry_to_wire(
    registry: &hooks::discovery::HookRegistry,
...
impl WorkspaceOps {
    ...
    pub async fn hook_registry(&self) -> WorkspaceResult<hooks::discovery::HookRegistry> {
...
mod tests {
    ...
    /// request types are defined in `workspace-types` (and re-exported
    ...
    fn hook_registry_wire_round_trip_both_directions() {
        let spec = hooks::config::HookSpec {
            ...
            event: hooks::event::HookEventName::PreToolUse,
        ...
        let mut registry = hooks::discovery::HookRegistry::default();
    ...
    fn hook_event_name_wire_covers_all_upstream_variants() {
        use hooks::event::HookEventName as E;
    ...
    /// can't depend on `hooks`, and `hook_registry_to_wire` only couples
    ...
    fn hook_spec_wire_covers_all_upstream_fields() {
        ...
        fn to_wire(spec: HookSpec) -> HookSpecWire {
            ...
            HookSpecWire {
                ...
                url_raw,
                timeout_ms,
                on_failure: on_failure.as_str().to_string(),
                source_dir,
                extra_env,
