...
//! `GROW_CLIPBOARD_NO_NATIVE_READ=1` disables the in-process read entirely
...
mod platform {
    ...
    fn run_attachments_osascript() -> anyhow::Result<String> {
        ...
        cmd.arg("-e")
            ...
            .stdout(Stdio::piped())
            .stderr(Stdio::piped());
        grow_tools::util::detach_std_command(&mut cmd);
...
mod platform {
    ...
    pub(super) fn wayland_data_control_supported() -> bool {
        ...
        // switch (precedent: GROW_CLIPBOARD_NO_NATIVE_READ) and non-Wayland
...
mod macos_probe_smoke {
    ...
    /// `cargo test -p grow-shared -- --ignored probe_smoke`.
    #[test]
