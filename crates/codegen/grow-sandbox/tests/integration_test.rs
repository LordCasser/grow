//! Integration tests for grow-sandbox.
//!
...
fn test_sandbox_logger() {
    use grow_sandbox::{SandboxEvent, SandboxLogger};
...
fn test_should_restrict_child_network_default() {
    ...
    assert!(!grow_sandbox::should_restrict_child_network());
}
