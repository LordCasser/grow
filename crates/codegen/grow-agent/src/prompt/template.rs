...
/// The base prompt template source, exposed for `grow prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `grow prompt --section apply-patch-template`.
