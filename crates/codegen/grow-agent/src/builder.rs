...
use grow_tools::registry::types::SessionContext;
...
/// tool registry in `grow-tools` (also used by the hook matcher).
fn claude_tool_kind(name: &str) -> Option<ToolKind> {
    grow_tools::types::kind_for(name)
}
...
pub struct AgentBuilder {
    ...
    /// `resolve_max_mcp_output_bytes_for_cwd` in grow-shell).
...
fn merge_tool_params(
    tool_config: &mut grow_tools::registry::types::ToolServerConfig,
    ids: &[&str],
...
impl AgentBuilder {
    pub fn new(
        ...
        Self {
            ...
            terminal_backend,
            fs_backend: Arc::new(grow_tools::computer::local::LocalFs),
            notification_handle,
    ...
    pub fn with_preloaded_skills(
        mut self,
        skills: Vec<grow_tools::implementations::skills::types::SkillInfo>,
    ) -> Self {
    ...
    pub fn with_memory_backend(
        mut self,
        backend: Arc<dyn grow_tools::types::memory_backend::MemoryBackend>,
    ) -> Self {
    ...
    pub fn with_parent_scheduler_handle(
        mut self,
        handle: grow_tools::implementations::grow_build::scheduler::types::SchedulerHandle,
    ) -> Self {
    ...
    pub fn with_web_fetch_config(
        mut self,
        config: grow_tools::implementations::grow_build::web_fetch::WebFetchConfig,
    ) -> Self {
    ...
    pub fn with_lsp(
        mut self,
        handle: std::sync::Arc<dyn grow_tools::implementations::lsp::LspBackend>,
    ) -> Self {
    ...
    pub fn with_app_builder_deployer_config(
        mut self,
        config: grow_tools::implementations::grow_build::deploy_app::AppBuilderDeployerConfig,
    ) -> Self {
    ...
    pub fn with_compat_config(mut self, compat: grow_tools::types::compat::CompatConfig) -> Self {
        self.compat = compat;
        self
    }
    ...
    pub async fn build(mut self) -> Result<Agent, AgentBuildError> {
        ...
        if self.memory_backend.is_none() {
            ...
            let mem_search_id = format!(
                "{grow_build_ns}:{}",
                grow_tools::implementations::memory::MEMORY_SEARCH_TOOL_NAME
            );
            let mem_get_id = format!(
                "{grow_build_ns}:{}",
                grow_tools::implementations::memory::MEMORY_GET_TOOL_NAME
            );
            tool_config
                .tools
        ...
        if !self.ask_user_question_enabled {
            let ask_user_id = format!(
                "{}:ask_user_question",
                grow_tools::types::tool::ToolNamespace::Grow,
            );
        ...
        if task_stripped {
            use grow_tools::types::tool::ToolNamespace;
        ...
        if let grow_tools::implementations::grow_build::web_fetch::WebFetchConfig::Enabled {
            ref params,
        ...
        if let Some(bytes) = self.mcp_max_output_bytes {
            tool_bridge.toolset().resources.lock().await.insert(
                grow_tools::types::resources::TruncationCfg(
...
fn resolve_shell_for_prompt() -> String {
    ...
    #[cfg(not(unix))]
    {
        grow_config::shell::detect_windows_shell()
            .name()
            .to_string()
    }
}
...
mod tests {
    ...
    fn entry(name: &str, desc: &str, source: SubagentSource) -> SubagentEntry {
        SubagentEntry {
            ...
            config_source: grow_tools::types::config_source::ConfigSource::Builtin,
        }
    }
    #[test]
    ...
    fn build_task_description_shadowed_builtin_uses_user_desc() {
        let subagents = vec![SubagentEntry {
            ...
            config_source: grow_tools::types::config_source::ConfigSource::Project {
    ...
    async fn plan_mode_injected_ask_user_question_receives_params() {
        use grow_tools::computer::local::LocalTerminalBackend;
        use grow_tools::implementations::grow_build::ask_user_question::AskUserQuestionParams;
        use grow_tools::notification::ToolNotificationHandle;
        use grow_tools::types::resources::Params;
    ...
    async fn spawning_blocked_disables_all_background_bash_modes() {
        use grow_tools::computer::local::LocalTerminalBackend;
        use grow_tools::implementations::grow_build::bash::BashParams;
        use grow_tools::notification::ToolNotificationHandle;
        use grow_tools::types::resources::Params;
