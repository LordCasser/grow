...
pub fn grow_build_hashline_toolset(
    hashline_tools: Vec<grow_tools::registry::types::ToolConfig>,
) -> ToolServerConfig {
    let mut tools: Vec<grow_tools::registry::types::ToolConfig> = vec![bash_tool_config()];
...
/// these into `grow_tools::registry::types::ToolsetConfig.bash`
...
impl AgentDefinition {
    ...
    pub fn override_file_tools(
        &mut self,
        file_tools: Vec<grow_tools::registry::types::ToolConfig>,
    ) {
