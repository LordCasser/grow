...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "GROW_SHOW_THINKING_BLOCKS";
...
pub const ENV_GROUP_TOOL_VERBS: &str = "GROW_GROUP_TOOL_VERBS";
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("GROW_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes GROW_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
