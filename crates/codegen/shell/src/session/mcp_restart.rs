...
//! window containing a [`::mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`::mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`::mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`::mcp::servers::ClientStateKind::Empty`]
