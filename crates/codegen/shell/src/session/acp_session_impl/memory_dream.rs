...
impl SessionActor {
    ...
    pub(super) fn emit_memory_session_summary(
        ...
        ::diagnostics::session_ctx::log_event(::diagnostics::memory_events::MemorySessionSummary {
    ...
    pub(super) async fn run_memory_flush(
        ...
        tracing::info!(target: ::diagnostics::memory_log::TARGET, outcome = %outcome, "MEMORY_FLUSH: completed");
        ...
        ::diagnostics::session_ctx::log_event(::diagnostics::memory_events::MemoryFlushComplete {
            session_id: self.session_info.id.to_string(),
            trigger: trigger.to_owned(),
        ...
        let flush_trigger = match trigger {
            "slash_command" => ::diagnostics::events::MemoryFlushTrigger::SlashCommand,
            "interval" => ::diagnostics::events::MemoryFlushTrigger::Interval,
            "pre_compaction" => ::diagnostics::events::MemoryFlushTrigger::PreCompaction,
            _ => ::diagnostics::events::MemoryFlushTrigger::UserRequested,
        };
        ::diagnostics::session_ctx::log_event(::diagnostics::events::MemoryFlushed {
