...
async fn create_test_actor_with_memory(
    ...
    gateway_tx: mpsc::UnboundedSender<acp_transport::AcpClientMessage>,
...
async fn create_injection_ready_actor(
    initial_conversation: Vec<sampling_types::ConversationItem>,
) -> SessionActor {
    ...
    local
        .run_until(async {
            let actor = create_injection_ready_actor(vec![
                sampling_types::ConversationItem::system("You are a helpful assistant."),
                sampling_types::ConversationItem::user(
        ...
        .run_until(async {
            let persisted_block =
                crate::session::helpers::memory_context::format_memory_reminder(&[
                    tools::types::memory_backend::MemorySearchResult {
                ...
                .unwrap();
            let actor = create_injection_ready_actor(vec![
                sampling_types::ConversationItem::system(format!(
