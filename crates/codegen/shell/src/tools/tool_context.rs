...
//! tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> tools::implementations::grow_build::task::types::SubagentForegroundWait {
    tools::implementations::grow_build::task::types::SubagentForegroundWait::new(move || {
...
impl ToolContext {
    ...
    pub fn new(
        ...
        let session_env = workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
