...
pub(crate) use definition::{
    ...
    apply_child_profile_policy, apply_child_tool_policy, apply_goal_object_tool_policy,
    apply_harness_toolset, available_agent_names, capture_agent_definitions,
    discover_agent_definition, gate_agent_definition, resolve_agent_definition,
    resolve_runtime_config, subagent_harness_flavor_is_representable, validate_agent_name,
};
