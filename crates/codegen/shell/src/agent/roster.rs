...
//! two ways:
//!
//!   - request/response `grow/sessions/list` → `{ "sessions": [RosterEntry, …] }`
//!   - broadcast notification `grow/sessions/changed` →
...
/// Response payload for `grow/sessions/list`.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
pub struct RosterListResponse {
    pub sessions: Vec<RosterEntry>,
}

/// Params payload for the `grow/sessions/changed` broadcast notification.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
...
pub const SESSIONS_LIST_METHOD: &str = "grow/sessions/list";
pub const SESSIONS_CHANGED_METHOD: &str = "grow/sessions/changed";
