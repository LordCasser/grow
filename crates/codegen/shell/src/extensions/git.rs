...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "grow/git/status" => {
            ...
            if let Some(ref git_root) = git_root {
                let current_commit = ops
                    .dispatch(
                        &workspace::workspace_ops::GitCurrentCommitReq {
        ...
        "grow/git/checkout_session_head" => {
            ...
            let opened = crate::session::storage::jsonl::JsonlStorageAdapter::new()
                .open_session_by_id(&req.session_id.0)
