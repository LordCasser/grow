...
impl SessionMode {
    ...
    pub fn behavior(&self) -> Option<tool_types::BehaviorId> {
        match self {
            Self::Default => None,
            Self::Ask => Some(tool_types::BehaviorId::Clarify),
            Self::Plan => Some(tool_types::BehaviorId::Plan),
            Self::Workflow => Some(tool_types::BehaviorId::Workflow),
            Self::DeepResearch => Some(tool_types::BehaviorId::DeepResearch),
            Self::Goal => Some(tool_types::BehaviorId::Goal),
        }
    }
}
