...
use crate::implementations::grow_build::task_output::{
...
impl crate::types::tool_metadata::ToolMetadata for WaitTasksTool {
    ...
    fn description_template(&self) -> &str {
        ...
        static DESC: std::sync::LazyLock<String> = std::sync::LazyLock::new(|| {
            tool_types::build_wait_tasks_description(&tool_types::WaitTasksToolNaming {
...
/// [`tool_types::build_wait_tasks_description`] builder so the CLI and
...
impl tool_runtime::Tool for WaitTasksTool {
    ...
    async fn run(
        ...
        let timeout = crate::implementations::grow_build::task_output::capped_wait_timeout(
            input.timeout_ms,
            crate::implementations::grow_build::task_output::max_wait_block(),
        );
