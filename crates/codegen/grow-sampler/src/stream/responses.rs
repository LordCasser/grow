    ...
    async_stream::stream! {
        ...
        loop {
            ...
            match event {
                ...
                // split (grow has no HostedTool::CodeInterpreter, so these events
        ...
        let mut items = grow_sampling_types::response_to_conversation_items(response);
        grow_sampling_types::inject_streaming_reasoning_fallback(&mut items, reasoning_acc);
