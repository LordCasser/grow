...
//! it" buckets.
//!
//! `grow-sampler` is intentionally decoupled from `grow-shell`
...
/// `grow_shell::auth::token_suffix` (which truncates to 12 chars
...
/// `grow-shell/src/auth/manager.rs` to match, otherwise the
...
/// `xai-grow-shell/src/auth/model.rs`, the comparison site.
