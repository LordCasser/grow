...
use pager_pty_harness::scroll_matrix::{CellReport, CellStatus, curated, run_cell, summary_table};
...
/// second run's stale-capture `remove_file` (and its pager's `GROW_SCROLL_LOG`
