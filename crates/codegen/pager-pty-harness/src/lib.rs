...
//!    `pager/tests/scenarios/`) — assert screen contents and
...
impl PtyHarness {
    ...
    /// Spawn from a canonical [`test_support::TestSandbox`] baseline
    ...
    /// # use pager_pty_harness::{PtyHarness, ContentController, pager_binary};
