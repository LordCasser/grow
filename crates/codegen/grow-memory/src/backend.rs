...
use grow_tools::types::memory_backend::{MemoryBackend, MemorySearchResult};
...
pub struct EndpointScopedCredentials {
    ...
    auth_credentials: Option<Arc<dyn grow_auth::AuthCredentialProvider>>,
...
impl EndpointScopedCredentials {
    ...
    fn auth_credentials(&self) -> Option<&Arc<dyn grow_auth::AuthCredentialProvider>> {
        self.auth_credentials.as_ref()
    }

    fn api_key_provider(&self) -> Option<&grow_tools::types::SharedApiKeyProvider> {
...
pub struct MemoryBackendParams {
    ...
    pub search_config: grow_config_types::MemorySearchConfig,
...
async fn build_embedding_provider(
    config: Option<&grow_config_types::MemoryEmbeddingConfig>,
...
pub struct MemoryBackendImpl {
    ...
    embed_config: Option<grow_config_types::MemoryEmbeddingConfig>,
    ...
    search_config: grow_config_types::MemorySearchConfig,
...
impl MemoryBackendImpl {
    ...
    pub fn new(db_path: PathBuf, storage: MemoryStorage) -> Self {
        Self {
            ...
            embed_api_key: None,
            search_config: grow_config_types::MemorySearchConfig::default(),
            watcher: None,
            stale_claim_secs: 60,
    ...
    pub fn with_embedding(
        mut self,
        config: grow_config_types::MemoryEmbeddingConfig,
        base_url: String,
    ...
    pub fn with_search_config(mut self, config: grow_config_types::MemorySearchConfig) -> Self {
...
impl MemoryBackendImpl {
    ...
    pub fn search_config_for_test(&self) -> &grow_config_types::MemorySearchConfig {
        &self.search_config
    }
}
...
impl MemoryBackend for MemoryBackendImpl {
    ...
    async fn search(
        ...
        let mut index = super::index::MemoryIndex::open_or_create(
            &self.db_path,
            self.storage.clone(),
            grow_config_types::MemoryIndexConfig::default(),
            embed_dims,
        )
...
mod factory_tests {
    ...
    use grow_config_types::{MemoryEmbeddingConfig, MemorySearchConfig};
    ...
    fn test_factory_wires_non_overridable_search_config_fields() {
        ...
        let custom_search = MemorySearchConfig {
            max_results: 7,
            mmr: grow_config_types::MmrConfig {
                enabled: true,
                lambda: 0.42,
            },
            temporal_decay: grow_config_types::TemporalDecayConfig {
                enabled: true,
                half_life_days: 14.0,
            },
            ..Default::default()
    ...
    async fn make_embedding_provider_uses_async_api_key_resolution() {
        ...
        let probe: grow_tools::types::SharedApiKeyProvider = Arc::new(AsyncProbe {
...
mod tests {
    ...
    async fn test_build_drops_credentials_when_request_url_differs() {
        let session: grow_tools::types::SharedApiKeyProvider = Arc::new(PanicKey);
        ...
        let config = grow_config_types::MemoryEmbeddingConfig {
    ...
    async fn test_trusted_endpoint_prefers_session_credential() {
        struct StubAuth;
        impl grow_auth::HttpAuth for StubAuth {
            fn apply(
                &self,
        ...
        let auth: Arc<dyn grow_auth::AuthCredentialProvider> = Arc::new(StubAuth);
        let api_key: grow_tools::types::SharedApiKeyProvider = Arc::new(PanicKey);
        let scoped = EndpointScopedCredentials::for_endpoint(
            "https://api.example.com/v1",
            |_| true,
            Some(auth),
    ...
    fn endpoint_scoped_credentials_trust_gate_and_url_match() {
        struct AnyKey;
        impl grow_tools::types::ApiKeyProvider for AnyKey {
            fn current_api_key(&self) -> Option<String> {
                None
            }
        }
        let key = || Arc::new(AnyKey) as grow_tools::types::SharedApiKeyProvider;
