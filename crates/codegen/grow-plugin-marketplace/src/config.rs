...
pub fn env_require_sha() -> bool {
    grow_config::env_bool("GROW_MARKETPLACE_REQUIRE_SHA").unwrap_or(false)
}
...
/// instead of `~/.grow`/`~/.claude`. Each root is checked for
