...
- [Hook Examples](../grow-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`grow-hooks`)](../grow-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`grow-plugin-marketplace`)](../grow-plugin-marketplace/) — marketplace source loading, scanning, and install
