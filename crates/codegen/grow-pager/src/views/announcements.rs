...
use grow_announcements::visible_announcements;
...
pub fn session_announcement_hide_keys_at(
    ...
    visible_announcements(announcements)
        ...
        .map(grow_announcements::announcement_hide_key)
        .collect()
}
...
mod tests {
    ...
    fn promo(id: &str, message: &str, cta: Option<(&str, &str)>) -> Announcement {
        Announcement {
            ...
            cta: cta.map(|(label, url)| grow_announcements::AnnouncementCta {
    ...
    fn promo_cta_target_requires_usable_pair() {
        ...
        label_only.cta = Some(grow_announcements::AnnouncementCta {
            label: Some("Go".into()),
            url: None,
            caption: None,
        });
