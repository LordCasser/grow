...
pub use grow_tools::implementations::grow_build::ask_user_question::{
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> grow_tools::implementations::grow_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: grow_tools::implementations::grow_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
