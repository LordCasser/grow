...
fn format_cost(m: &grow_shell::extensions::notification::PromptUsageModel) -> String {
    use grow_shell::extensions::notification::ticks_to_usd;
...
mod tests {
    use super::*;
    use grow_shell::extensions::notification::{PromptUsage, PromptUsageModel};
