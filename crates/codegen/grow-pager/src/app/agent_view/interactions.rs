...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use grow_tools::implementations::grow_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            grow_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
...
mod question_no_freeform_tests {
    ...
    //! fixed-choice questions. Regression tests for the bug where clicking
    ...
    fn fixed_choice_question() -> Question {
        ...
        Question {
            question: "Choose how this task should run.".into(),
            options: vec![
                opt("Use recommended settings", "For everyday coding"),
                opt("Use advanced settings", "More control"),
            ],
