...
/// [`grow_shell::util::config::resolve_hints`]; this type is the pager's
/// in-memory mirror.
...
impl From<grow_shell::util::config::WorktreeHintMode> for WorktreeMode {
    fn from(mode: grow_shell::util::config::WorktreeHintMode) -> Self {
        use grow_shell::util::config::WorktreeHintMode;
        match mode {
...
impl WorktreeMode {
    ...
    pub fn from_config_str(s: &str) -> Self {
        grow_shell::util::config::WorktreeHintMode::from_config_str(s).into()
    }
    ...
    pub fn resolve_from_hints_value(hints: Option<&toml::Value>) -> (Self, Self) {
        let (new_session, fork) = grow_shell::util::config::WorktreeHintMode::resolve_pair(hints);
...
pub struct AppView {
    ...
    /// stays sans-IO.
    pub current_ui: grow_shell::agent::config::UiConfig,
    /// Working directory.
    pub cwd: PathBuf,
    /// Whether the project picker question has already been shown this session.
    pub project_picker_shown: bool,
    /// "Don't ask me again" opt-out from [`grow_shell::util::config::resolve_hints`];
    ...
    /// empty and inert outside `--minimal`; the `grow-pager-minimal` crate
    ...
    pub session_picker_content_results:
        Option<Vec<grow_shell::extensions::session_search::SearchSessionHit>>,
    ...
    pub contextual_hints: grow_shell::util::config::ResolvedContextualHints,
    ...
    pub remote_contextual_hints: Option<grow_shell::util::config::ContextualHintsRemote>,
...
impl AppView {
    ...
    pub fn new(
        ...
        Self {
            ...
            current_ui: grow_shell::agent::config::UiConfig::default(),
            ...
            auto_mode_gate: grow_shell::util::config::auto_permission_mode_enabled_from_disk(),
    ...
    pub fn deferred_model_switch_from_cli(
        ...
        acp::ModelId,
        Option<grow_shell::sampling::types::ReasoningEffort>,
    )> {
...
struct WelcomeInputCtx<'a> {
    ...
    sp_content_results: &'a Option<Vec<grow_shell::extensions::session_search::SearchSessionHit>>,
...
impl AppView {
    ...
    pub fn apply_contextual_hints(
        &mut self,
        resolved: grow_shell::util::config::ResolvedContextualHints,
    ) {
...
pub(crate) mod tests {
    ...
    fn needs_animation_gates_todo_badge_flash() {
        ...
        app.agents
            ...
            .unwrap()
            .todo
            .update_todos(vec![grow_shell::tools::TodoItem {
                content: "do the thing".into(),
                priority: Default::default(),
                status: grow_shell::tools::TodoStatus::InProgress,
                meta: None,
            }]);
        assert!(
    ...
    fn esc_owned_before_agent_covers_app_level_owners() {
        ...
        app.import_claude_modal = Some(
            crate::views::import_claude_modal::ImportClaudeModalState::new(
                grow_shell::claude_import::ImportPlan::default(),
    ...
    fn overlay_left_arrow_file_search_open_does_not_exit() {
        let (mut app, id) = neutral_overlay_app();
        {
            ...
            agent.prompt.file_search.set_test_state(
                ctx,
                vec![grow_workspace::file_system::FuzzyMatchResult {
