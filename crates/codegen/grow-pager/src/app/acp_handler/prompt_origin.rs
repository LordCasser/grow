...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    grow_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        grow_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        grow_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        grow_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        grow_shell::session::PromptOrigin::TaskCompleted { .. }
            | grow_shell::session::PromptOrigin::SubagentCompleted { .. }
            | grow_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | grow_shell::session::PromptOrigin::NotificationDrain
    )
}
