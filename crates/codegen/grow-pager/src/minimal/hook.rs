...
//! render mode.
//!
//! `grow-pager` cannot depend on `grow-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`grow-pager-bin`) wires it up once at
//! startup by calling `grow_pager_minimal::install()`. When nothing has
