...
// minimal rendering lives in the sibling `grow-pager-minimal` crate; these
...
// `grow-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use grow_pager_render::{
