...
/// 15. **In-session Ctrl+R cycles permission mode.**
/// Routes Ctrl+R through the agent view's action registry; the welcome-screen
/// case separately covers forwarding the action into a newly created session.
/// With the auto gate on (client default): Normal → Plan → Auto → Always-Approve → Normal.
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore]
async fn ctrl_r_in_session_cycles_mode() {
