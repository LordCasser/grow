//! Criterion benchmarks for the grow-pager rendering pipeline.
//!
...
use grow_pager::scrollback::render::render_scrolled_entries_with_scratch;
use grow_pager::scrollback::wrappers::EntryRenderer;
use grow_pager::scrollback::{
