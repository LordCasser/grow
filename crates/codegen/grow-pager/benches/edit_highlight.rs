...
//!
//! ```text
//! cargo bench -p grow-pager --bench edit_highlight
//! cargo bench -p grow-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use grow_pager::diff::{DiffHunk, DiffLine};
use grow_pager::scrollback::blocks::tool::{
...
use grow_pager::syntax::{Syntect, get_syntect};
