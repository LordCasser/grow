...
use grow_pager::scrollback::blocks::ToolCallBlock;
use grow_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn btw_block_emits_once_across_repeated_frontier_passes() {
        ...
        s.push(ScrollbackEntry::new(RenderBlock::Btw(
            grow_pager::scrollback::blocks::BtwBlock::new("original question", "original answer"),
        )));
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use grow_pager::theme::cache as theme_cache;
        use ratatui::buffer::Buffer;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                grow_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
    ...
    fn commit_display_mode_lookups_collapse_on_success_only() {
        use grow_pager::scrollback::blocks::{
