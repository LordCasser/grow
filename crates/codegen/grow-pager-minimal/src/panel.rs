...
use grow_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use grow_pager::views::modal::ActiveModal;
use grow_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use grow_pager::views::extensions_modal::ExtensionsModalState;
    use grow_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    use ratatui::layout::Rect;
    ...
    fn session_entry(id: &str) -> grow_pager::app::app_view::SessionPickerEntry {
        grow_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<grow_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
