...
//! payloads come from `test_support::sse`.
...
use sampling_types::{ConversationItem, ConversationRequest, DoomLoopRecoveryPolicy, UserItem};
...
fn user_request(text: &str) -> ConversationRequest {
    ConversationRequest {
        items: vec![ConversationItem::User(UserItem {
            content: vec![sampling_types::ContentPart::Text {
