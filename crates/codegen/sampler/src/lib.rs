//! sampler - Provider-neutral actor-based sampling layer for Grow.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `hunk-tracker`.
//!
//! ## Layered API
//!
...
pub use handle::{AttemptScopeCapture, AttemptUsage, AttemptUsageSink, SamplerHandle};
