//! Installed grow CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "GROW_TEST_VERSION";

pub const VERSION: &str = match option_env!("GROW_VERSION") {
    Some(v) => v,
