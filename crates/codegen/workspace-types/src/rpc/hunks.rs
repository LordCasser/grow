...
/// Wire-safe hunk action enum. Maps to `hunk_tracker::types::HunkAction`
...
// =========================================================================
// Request types whose responses reference `hunk_tracker` types (which pull
...
/// Wire mirror of `hunk_tracker::types::Hunk` (the `selected` field is
