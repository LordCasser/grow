//! ToolBridge: adapter that wraps `grow-tools`'s `ToolRegistry` and
...
impl ToolBridge {
    ...
    /// `Some("get_task_output")` for the grow_build agent and `None` for
    ...
    pub async fn list_scheduled_tasks(
        &self,
    ) -> Vec<crate::implementations::grow_build::scheduler::types::ScheduledTask> {
        use crate::implementations::grow_build::scheduler::types::{
    ...
    pub async fn delete_scheduled_task(
        ...
        reply_rx
            ...
            .map_err(crate::implementations::grow_build::scheduler::types::scheduler_tool_error)
    }
...
mod tests {
    ...
    fn tool_kind_returns_registered_kind_per_namespace_and_none_for_unknown() {
        ...
        // PascalCase + grow_build's snake_case in one registry
