...
//! Run:
//! ```bash
//! cargo test -p grow-tools --test path_suggestions_production
//! ```

use grow_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &grow_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_grow_sessions_internal_path() {
