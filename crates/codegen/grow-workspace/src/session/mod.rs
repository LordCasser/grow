...
use grow_mcp::servers::McpState;
use grow_tools::notification::types::{ToolNotification, ToolNotificationHandle};
use grow_tools::registry::types::{FinalizedToolset, ToolConfig, ToolServerConfig};
...
impl WorkspaceSession {
    ...
    pub(crate) async fn toolset_terminal_is_session_owned(&self) -> bool {
        ...
        match res.get::<grow_tools::types::resources::Terminal>() {
...
pub struct WorkspaceShared {
    ...
    pub(crate) events: tokio::sync::broadcast::Sender<grow_workspace_types::WorkspaceEvent>,
    pub(crate) respect_gitignore: bool,
    pub(crate) memory_config: Option<MemoryConfig>,
    pub(crate) hook_registry: Arc<parking_lot::RwLock<grow_hooks::discovery::HookRegistry>>,
    pub(crate) hook_load_errors: Vec<grow_hooks::error::HookError>,
    ...
    pub(crate) activity_notify_handle:
        arc_swap::ArcSwap<Option<grow_tools::notification::types::ToolNotificationHandle>>,
    /// Sink for workspace-originated ext-notifications to the client (e.g.
    /// `grow/search/fuzzy/status`). Mode-agnostic: the shell wires it to the
    ...
    pub(crate) lsp: Option<std::sync::Arc<dyn grow_tools::implementations::lsp::LspBackend>>,
...
impl WorkspaceShared {
    ...
    pub fn subscribe_events(
        &self,
    ) -> tokio::sync::broadcast::Receiver<grow_workspace_types::WorkspaceEvent> {
