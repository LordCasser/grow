...
impl From<&grow_tools::types::ToolInput> for AccessKind {
    fn from(input: &grow_tools::types::ToolInput) -> Self {
...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use grow_tools::implementations::grow_build_hashline::edit::types::HashlineEditInput;
        use grow_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use grow_tools::implementations::grow_build::bash::BashToolInput;
        use grow_tools::types::ToolInput;
    ...
    fn monitor_maps_to_bash_access() {
        use grow_tools::implementations::grow_build::monitor::types::MonitorInput;
        use grow_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use grow_tools::implementations::grow_build::web_fetch::WebFetchInput;
        use grow_tools::types::ToolInput;
    ...
    #[test]
    fn client_type_deserializes_grow_shell_as_generic() {
        assert_eq!(
