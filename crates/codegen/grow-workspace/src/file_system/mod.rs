...
// its wire types live in `grow_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use grow_workspace_types::rpc::fs::FsReadEncoding;
...
pub use grow_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
