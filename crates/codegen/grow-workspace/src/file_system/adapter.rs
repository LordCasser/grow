//! AcpFsAdapter: implements `grow-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates grow-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use grow_tools::computer::types::{AsyncFileSystem, ComputerError};
use xai_acp_lib::AcpAgentGatewaySender as GatewaySender;

/// Wraps grow-shell's ACP gateway to satisfy grow-tools' AsyncFileSystem.
///
