...
pub fn pump_transcript(app: &mut AppView) {
    ...
    let appearance = super::commit::committed_appearance(minimal_api::app_appearance(app));
    {
        ...
        let prev_thinking = pager::appearance::cache::load_show_thinking_blocks();
        ...
        pager::appearance::cache::set_show_thinking_blocks(prev_thinking);
    }
...
mod tests {
    ...
    fn transcript_expands_thinking_committed_collapsed() {
        let theme = Theme::current();
        let appearance =
            super::super::commit::committed_appearance(&pager::appearance::AppearanceConfig {
