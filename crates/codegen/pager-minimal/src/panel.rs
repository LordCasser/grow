...
use pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use pager::views::modal::ActiveModal;
use pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    ...
    fn with_resume(entries: Vec<pager::app::app_view::SessionPickerEntry>) -> AgentView {
        ...
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: pager::views::modal_window::ModalWindowState::new(),
