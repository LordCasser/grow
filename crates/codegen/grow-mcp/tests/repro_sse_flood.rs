...
//!
//! Run with: cargo test -p grow-mcp --test repro_sse_flood -- --nocapture
...
use grow_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use grow_mcp::rmcp::ServiceExt;
use grow_mcp::rmcp::transport::StreamableHttpClientTransport;
use grow_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
