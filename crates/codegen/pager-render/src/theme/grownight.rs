//! GrowNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// GrowNight palette — neutral gray base + TokyoNight accent colors.
//
