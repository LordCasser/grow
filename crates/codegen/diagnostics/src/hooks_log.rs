...
//! targets `hooks` or `agent::plugins` at key lifecycle
...
/// Filters to hooks (`hooks`) and plugins (`agent::plugins`) targets.
    ...
    S: Subscriber + for<'span> LookupSpan<'span>,
{
    ...
    let filter = tracing_subscriber::filter::EnvFilter::new("hooks=debug,agent::plugins=debug");
