...
//!
//! In dev mode, watches ~/.grow/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.grow/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.grow/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = grow_config::user_grow_home()
