...
//! string/text manipulation. Harness-bound extraction (Grow chat's
//! `GrowConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `GrowMessage` assembly) stays in the harness crate.
