...
全仓库逐包提取正在 [inventory-all-crate-features](changes/inventory-all-crate-features/tasks.md) 进行，完成度及验证边界见 [阶段复验](changes/inventory-all-crate-features/verification.md)。进行中的 delta 尚未成为主规范。
