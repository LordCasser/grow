...
- [Mermaid render dispatch](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-render-dispatch)
- [Mermaid theme precedence](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-theme-precedence)
- [Mermaid language fence recognition](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-language-fence-recognition)
- [Mermaid frontmatter boundary](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-frontmatter-boundary)
- [Mermaid invalid YAML stripping](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-invalid-yaml-stripping)
- [Mermaid configuration coercion](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-configuration-coercion)
- [Mermaid font size normalization](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-font-size-normalization)
- [Mermaid stored configuration limits](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-stored-configuration-limits)
- [Mermaid state configuration boundary](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-state-configuration-boundary)
- [Mermaid disabled experimental port](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-disabled-experimental-port)
- [Mermaid Unicode width estimation](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-unicode-width-estimation)
- [Mermaid word wrapping](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-word-wrapping)
- [Mermaid long token split](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-long-token-split)
- [Mermaid wrapped height](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-wrapped-height)
- [Mermaid flowchart declaration](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-declaration)
- [Mermaid flowchart statement termination](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-statement-termination)
- [Mermaid flowchart edge chains](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-edge-chains)
- [Mermaid flowchart label normalization](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-label-normalization)
- [Mermaid flowchart node shapes](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-node-shapes)
- [Mermaid flowchart subgraph identifiers](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-subgraph-identifiers)
- [Mermaid flowchart style parsing](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-flowchart-style-parsing)
- [Mermaid node declaration replacement](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-node-declaration-replacement)
- [Mermaid subgraph ownership](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-subgraph-ownership)
- [Mermaid effective node styles](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-effective-node-styles)
- [Mermaid Dagre graph and duplicate edges](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-dagre-graph-and-duplicate-edges)
- [Mermaid cycle edge detection](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-cycle-edge-detection)
- [Mermaid cluster endpoint anchors](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-cluster-endpoint-anchors)
- [Mermaid nested subgraph bounds](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-nested-subgraph-bounds)
- [Mermaid connected subgraph centering](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-connected-subgraph-centering)
- [Mermaid subgraph overlap resolution](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-subgraph-overlap-resolution)
- [Mermaid state rank adjustment](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-state-rank-adjustment)
- [Mermaid state terminal alignment](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-state-terminal-alignment)
- [Mermaid shape measurement](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-shape-measurement)
- [Mermaid collapsed internal ranks](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-collapsed-internal-ranks)
- [Mermaid obstacle routing limits](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-obstacle-routing-limits)
- [Mermaid back edge routes](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-back-edge-routes)
- [Mermaid self loop routes](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-self-loop-routes)
- [Mermaid aligned edge straightening](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-aligned-edge-straightening)
- [Mermaid cluster interior route trimming](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-cluster-interior-route-trimming)
- [Mermaid shape clipping approximation](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-shape-clipping-approximation)
- [Mermaid layout final bounds](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-layout-final-bounds)
- [Mermaid info fixed output](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-info-fixed-output)
- [Mermaid pie input and slices](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-pie-input-and-slices)
- [Mermaid pie legend and theme](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-pie-legend-and-theme)
- [Mermaid packet bit rows](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-packet-bit-rows)
- [Mermaid timeline section grouping](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-timeline-section-grouping)
- [Mermaid timeline sizing](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-timeline-sizing)
- [Mermaid journey scores and actors](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-journey-scores-and-actors)
- [Mermaid journey label fallback](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-journey-label-fallback)
- [Mermaid quadrant coordinates](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-quadrant-coordinates)
- [Mermaid radar axis and curves](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-radar-axis-and-curves)
- [Mermaid sankey input and cycles](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sankey-input-and-cycles)
- [Mermaid sankey scale and palette](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sankey-scale-and-palette)
- [Mermaid mindmap indentation](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-mindmap-indentation)
- [Mermaid mindmap radial layout](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-mindmap-radial-layout)
- [Mermaid gantt dependencies](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gantt-dependencies)
- [Mermaid gantt calendar limits](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gantt-calendar-limits)
- [Mermaid gantt render scale](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gantt-render-scale)
- [Mermaid kanban grammar](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-kanban-grammar)
- [Mermaid kanban metadata](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-kanban-metadata)
- [Mermaid kanban card rendering](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-kanban-card-rendering)
- [Mermaid block grammar](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-block-grammar)
- [Mermaid block node labels](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-block-node-labels)
- [Mermaid block grid geometry](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-block-grid-geometry)
- [Mermaid block attribute escaping](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-block-attribute-escaping)
- [Mermaid gitgraph branch operations](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gitgraph-branch-operations)
- [Mermaid gitgraph commit identity](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gitgraph-commit-identity)
- [Mermaid gitgraph merge semantics](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gitgraph-merge-semantics)
- [Mermaid gitgraph visual layout](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-gitgraph-visual-layout)
- [Mermaid XY supported plots](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-xy-supported-plots)
- [Mermaid XY category parsing](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-xy-category-parsing)
- [Mermaid XY numeric domains](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-xy-numeric-domains)
- [Mermaid XY series alignment](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-xy-series-alignment)
- [Mermaid XY plot presentation](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-xy-plot-presentation)
- [Mermaid XY malformed number lists](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-xy-malformed-number-lists)
- [Mermaid state declarations](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-state-declarations)
- [Mermaid state transitions](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-state-transitions)
- [Mermaid requirement node kinds](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-requirement-node-kinds)
- [Mermaid requirement properties](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-requirement-properties)
- [Mermaid requirement relationships](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-requirement-relationships)
- [Mermaid requirement layout](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-requirement-layout)
- [Mermaid requirement contains marker](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-requirement-contains-marker)
- [Mermaid ER entity attributes](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-er-entity-attributes)
- [Mermaid ER cardinality](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-er-cardinality)
- [Mermaid ER layout and labels](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-er-layout-and-labels)
- [Mermaid ER dark stripes](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-er-dark-stripes)
- [Mermaid class declarations](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-declarations)
- [Mermaid class relation operators](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-relation-operators)
- [Mermaid class cardinality labels](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-cardinality-labels)
- [Mermaid class box sizing](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-box-sizing)
- [Mermaid class layout bounds](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-layout-bounds)
- [Mermaid class edge clipping](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-edge-clipping)
- [Mermaid class theme boundary](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-class-theme-boundary)
- [Mermaid C4 declarations](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-c4-declarations)
- [Mermaid C4 function arguments](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-c4-function-arguments)
- [Mermaid C4 boundaries](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-c4-boundaries)
- [Mermaid C4 relations](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-c4-relations)
- [Mermaid C4 dynamic numbering](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-c4-dynamic-numbering)
- [Mermaid C4 presentation](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-c4-presentation)
- [Mermaid sequence participants](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-participants)
- [Mermaid sequence alias merging](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-alias-merging)
- [Mermaid sequence lifecycle limits](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-lifecycle-limits)
- [Mermaid sequence message arrows](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-message-arrows)
- [Mermaid sequence autonumber](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-autonumber)
- [Mermaid sequence note grammar](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-note-grammar)
- [Mermaid sequence fragments](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-fragments)
- [Mermaid sequence activations](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-activations)
- [Mermaid sequence fragment geometry](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-fragment-geometry)
- [Mermaid sequence sizing](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-sequence-sizing)
- [Mermaid SVG paint order](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-paint-order)
- [Mermaid SVG shape rendering](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-shape-rendering)
- [Mermaid SVG text options](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-text-options)
- [Mermaid SVG edge styles](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-edge-styles)
- [Mermaid SVG curve mode](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-curve-mode)
- [Mermaid SVG label placement](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-label-placement)
- [Mermaid SVG label background](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-svg-label-background)
- [Mermaid port database boundary](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-port-database-boundary)
- [Mermaid port flow data order](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-port-flow-data-order)
- [Mermaid port cluster extraction](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-port-cluster-extraction)
- [Mermaid port recursive layout](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-port-recursive-layout)
- [Mermaid port options and dimensions](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-port-options-and-dimensions)
- [Mermaid theme preset parsing](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-theme-preset-parsing)
- [Mermaid theme variable aliases](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-theme-variable-aliases)
- [Mermaid theme sparse overrides](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-theme-sparse-overrides)
- [Mermaid public error surface](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-public-error-surface)
- [Mermaid vendored library boundary](draft-deltas/mermaid-svg-rendering/spec.md#requirement-mermaid-vendored-library-boundary)
