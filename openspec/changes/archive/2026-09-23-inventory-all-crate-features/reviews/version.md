...
- [Installed version and display](draft-deltas/application-maintenance/spec.md#requirement-installed-version-and-display)：版本层 SHALL 以编译期 GROW_VERSION 优先于 package version，installed() 允许运行期 GROW_TEST_VERSION 覆盖并去除两端空白；展示函数分别追加渠道后缀。
