...
- [Conversation item determines buffered message cause](draft-deltas/chat-state/spec.md#requirement-conversation-item-determines-buffered-message-cause)
- [Durable response admission and native fragment installation](draft-deltas/chat-state/spec.md#requirement-durable-response-admission-and-native-fragment-installation)
- [Empty response resets native continuation](draft-deltas/chat-state/spec.md#requirement-empty-response-resets-native-continuation)
- [Explicit history repair dry run](draft-deltas/chat-state/spec.md#requirement-explicit-history-repair-dry-run)
- [Usage token arithmetic](draft-deltas/chat-state/spec.md#requirement-usage-token-arithmetic)
- [Usage ledger model aggregation](draft-deltas/chat-state/spec.md#requirement-usage-ledger-model-aggregation)
- [Partial cost and incomplete usage](draft-deltas/chat-state/spec.md#requirement-partial-cost-and-incomplete-usage)
- [Persistence port acknowledgement](draft-deltas/chat-state/spec.md#requirement-persistence-port-acknowledgement)
- [Permanent persistence error classification](draft-deltas/chat-state/spec.md#requirement-permanent-persistence-error-classification)
- [Serial actor bootstrap](draft-deltas/chat-state/spec.md#requirement-serial-actor-bootstrap)
- [Durable commit retry and cancellation](draft-deltas/chat-state/spec.md#requirement-durable-commit-retry-and-cancellation)
- [Handle lifetime and query failure](draft-deltas/chat-state/spec.md#requirement-handle-lifetime-and-query-failure)
- [Sampling route replacement resets continuation](draft-deltas/chat-state/spec.md#requirement-sampling-route-replacement-resets-continuation)
- [Snapshot projection boundary](draft-deltas/chat-state/spec.md#requirement-snapshot-projection-boundary)
- [Conditional tool result admission](draft-deltas/chat-state/spec.md#requirement-conditional-tool-result-admission)
- [Tool result pruning plan execution](draft-deltas/chat-state/spec.md#requirement-tool-result-pruning-plan-execution)
- [Provider pressure anchor lower bound](draft-deltas/chat-state/spec.md#requirement-provider-pressure-anchor-lower-bound)
- [Request pressure envelope replacement](draft-deltas/chat-state/spec.md#requirement-request-pressure-envelope-replacement)
- [Durable memory request injection](draft-deltas/chat-state/spec.md#requirement-durable-memory-request-injection)
- [Request image projection scope](draft-deltas/chat-state/spec.md#requirement-request-image-projection-scope)
- [Image body estimate limitation](draft-deltas/chat-state/spec.md#requirement-image-body-estimate-limitation)
- [Prompt cache lineage key](draft-deltas/chat-state/spec.md#requirement-prompt-cache-lineage-key)
- [Continuation projection reconciliation](draft-deltas/chat-state/spec.md#requirement-continuation-projection-reconciliation)
- [Request token estimate components](draft-deltas/chat-state/spec.md#requirement-request-token-estimate-components)
- [First user text actual scan](draft-deltas/chat-state/spec.md#requirement-first-user-text-actual-scan)
- [Timeline schema sequence and sealing](draft-deltas/chat-state/spec.md#requirement-timeline-schema-sequence-and-sealing)
- [Timeline prepare and replay](draft-deltas/chat-state/spec.md#requirement-timeline-prepare-and-replay)
- [Seed prompt coordinate reset](draft-deltas/chat-state/spec.md#requirement-seed-prompt-coordinate-reset)
- [Interrupted lifecycle recovery boundary](draft-deltas/chat-state/spec.md#requirement-interrupted-lifecycle-recovery-boundary)
- [Stable surface replacement range](draft-deltas/chat-state/spec.md#requirement-stable-surface-replacement-range)
- [Message cause shape validation](draft-deltas/chat-state/spec.md#requirement-message-cause-shape-validation)
- [Direct user evidence validation boundary](draft-deltas/chat-state/spec.md#requirement-direct-user-evidence-validation-boundary)
- [Control context activation boundaries](draft-deltas/chat-state/spec.md#requirement-control-context-activation-boundaries)
- [Input admission routing and reservation](draft-deltas/chat-state/spec.md#requirement-input-admission-routing-and-reservation)
- [Workflow execution epochs and closure](draft-deltas/chat-state/spec.md#requirement-workflow-execution-epochs-and-closure)
- [Compaction summary replacement settlement](draft-deltas/chat-state/spec.md#requirement-compaction-summary-replacement-settlement)
- [Notification deterministic identity](draft-deltas/chat-state/spec.md#requirement-notification-deterministic-identity)
- [Notification inbox retention](draft-deltas/chat-state/spec.md#requirement-notification-inbox-retention)
- [Notification consumption ownership](draft-deltas/chat-state/spec.md#requirement-notification-consumption-ownership)
- [Hook gate classification](draft-deltas/chat-state/spec.md#requirement-hook-gate-classification)
- [Frozen hook handler lifecycle](draft-deltas/chat-state/spec.md#requirement-frozen-hook-handler-lifecycle)
- [Hook aggregate decisions](draft-deltas/chat-state/spec.md#requirement-hook-aggregate-decisions)
- [Hook failure policy restriction](draft-deltas/chat-state/spec.md#requirement-hook-failure-policy-restriction)
- [Sideband independent event ledger](draft-deltas/chat-state/spec.md#requirement-sideband-independent-event-ledger)
- [Sideband frozen request budget](draft-deltas/chat-state/spec.md#requirement-sideband-frozen-request-budget)
- [Sideband attempt source containment](draft-deltas/chat-state/spec.md#requirement-sideband-attempt-source-containment)
- [Sideband result and terminal validation](draft-deltas/chat-state/spec.md#requirement-sideband-result-and-terminal-validation)
- [Sideband parent and recall linkage](draft-deltas/chat-state/spec.md#requirement-sideband-parent-and-recall-linkage)
- [Subagent seed linkage](draft-deltas/chat-state/spec.md#requirement-subagent-seed-linkage)
- [Subagent terminal result linkage](draft-deltas/chat-state/spec.md#requirement-subagent-terminal-result-linkage)
- [Image projection identity and provenance](draft-deltas/chat-state/spec.md#requirement-image-projection-identity-and-provenance)
- [Branch transcript preserves pruning provenance](draft-deltas/chat-state/spec.md#requirement-branch-transcript-preserves-pruning-provenance)
- [Completed compaction unloaded history](draft-deltas/chat-state/spec.md#requirement-completed-compaction-unloaded-history)
- [User title override permanence](draft-deltas/chat-state/spec.md#requirement-user-title-override-permanence)
- [Trajectory projection and snapshot hydration](draft-deltas/chat-state/spec.md#requirement-trajectory-projection-and-snapshot-hydration)
- [Trajectory surface visibility](draft-deltas/chat-state/spec.md#requirement-trajectory-surface-visibility)
- [Trajectory repair provenance links](draft-deltas/chat-state/spec.md#requirement-trajectory-repair-provenance-links)
- [Trajectory state outcome and severity](draft-deltas/chat-state/spec.md#requirement-trajectory-state-outcome-and-severity)
- [Trajectory summary truncation](draft-deltas/chat-state/spec.md#requirement-trajectory-summary-truncation)
- [Complete turn boundary heuristic](draft-deltas/chat-state/spec.md#requirement-complete-turn-boundary-heuristic)
- [Summary preparation modes](draft-deltas/chat-state/spec.md#requirement-summary-preparation-modes)
- [Conversation budget fitting heuristic](draft-deltas/chat-state/spec.md#requirement-conversation-budget-fitting-heuristic)
- [User query metadata extraction](draft-deltas/chat-state/spec.md#requirement-user-query-metadata-extraction)
- [Real user query classification](draft-deltas/chat-state/spec.md#requirement-real-user-query-classification)
- [Compaction range planning](draft-deltas/chat-state/spec.md#requirement-compaction-range-planning)
- [Compaction state context assembly](draft-deltas/chat-state/spec.md#requirement-compaction-state-context-assembly)
- [Compacted history sanitation scope](draft-deltas/chat-state/spec.md#requirement-compacted-history-sanitation-scope)
- [History quarantine and pairing sequence](draft-deltas/chat-state/spec.md#requirement-history-quarantine-and-pairing-sequence)
- [Actor usage attribution](draft-deltas/chat-state/spec.md#requirement-actor-usage-attribution)
- [Independent incomplete usage flags](draft-deltas/chat-state/spec.md#requirement-independent-incomplete-usage-flags)
- [Durable rewind bookkeeping](draft-deltas/chat-state/spec.md#requirement-durable-rewind-bookkeeping)
- [Turn capture event provenance](draft-deltas/chat-state/spec.md#requirement-turn-capture-event-provenance)
- [Unavailable query return distinctions](draft-deltas/chat-state/spec.md#requirement-unavailable-query-return-distinctions)
- [Latest assistant text query](draft-deltas/chat-state/spec.md#requirement-latest-assistant-text-query)
- [Latest model metadata projection](draft-deltas/chat-state/spec.md#requirement-latest-model-metadata-projection)
- [Automatic compaction query delegation](draft-deltas/chat-state/spec.md#requirement-automatic-compaction-query-delegation)
- [Atomic surface and revision query](draft-deltas/chat-state/spec.md#requirement-atomic-surface-and-revision-query)
- [Request and tool lifecycle ownership](draft-deltas/chat-state/spec.md#requirement-request-and-tool-lifecycle-ownership)
- [Input submission idempotence](draft-deltas/chat-state/spec.md#requirement-input-submission-idempotence)
- [Explicit repair active turn guard](draft-deltas/chat-state/spec.md#requirement-explicit-repair-active-turn-guard)
- [Surface replacement no operation](draft-deltas/chat-state/spec.md#requirement-surface-replacement-no-operation)
- [Chat state feature and metadata surfaces](draft-deltas/chat-state/spec.md#requirement-chat-state-feature-and-metadata-surfaces)
- [Input reroute transitions](draft-deltas/chat-state/spec.md#requirement-input-reroute-transitions)
